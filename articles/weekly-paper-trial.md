...
- 書くことによって、今の研究に不足していることがわかる
  ...
  - etc...
- 推敲する力がつく
- 「形になるもの」が完成するため、先生も安心する・確認できる

アジャイルはチームがカオスな課題を解決するために存在します。
そのため、なかなか個人志向の研究には難しいところです。
...
そこで、毎週論文をインクリメンタルに書くことを目指して、 GitHub Actions で実現することにしました。
...
`main.yaml`と比較して、`weekly.yaml`ではいくつか変更しています。
...
Release と Asset 作成が終わったら Slack に通知します。
